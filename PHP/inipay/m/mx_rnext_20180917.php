	...
	/////////////////////////////////////////////////////////////////////////////
	  ...
	  */
	  ...
	  if($inimx->m_resultCode == "00"){ //성공
			...
			echo "<script>alert('결제 승인 완료되었습니다.');opener.top.location.href='https://whats-up.me/user/main';self.close();</script>";	
	  }else{
			echo "<script>alert('결제 승인 실패되었습니다.');opener.top.location.href='https://whats-up.me/user/main';self.close();</script>";	
	  }
  }else{
	echo "<script>alert('결제 승인 실패되었습니다.');opener.top.location.href='https://whats-up.me/user/main';self.close();</script>";		
  }
